  ...
  return (
    <header className="hero" id="top">
      ...
      <div className="shell hero-inner">
        <h1 className="hero-title" data-reveal style={{ '--d': '0ms' } as CSSProperties}>
          {C.title[0]}<br />{C.title[1]}<span className="hero-period">.</span>
        </h1>
        <p className="hero-sub" data-reveal style={{ '--d': '90ms' } as CSSProperties}>{C.sub}</p>
        <div className="hero-actions" data-reveal style={{ '--d': '170ms' } as CSSProperties}>
